...
public class CommandsQueueRepositoryTest extends BaseTaskReactorIntegrationTest {

  private final CommandsQueueRepository repository =
      CommandsQueueRepository.getInstance(session, Identifier.from(TEST_INSTANCE));
