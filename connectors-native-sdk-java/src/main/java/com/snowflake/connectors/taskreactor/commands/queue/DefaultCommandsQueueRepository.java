...
import static com.snowflake.connectors.taskreactor.commands.queue.CommandsQueueRepository.ColumnName.ID;
...
public class DefaultCommandsQueueRepository implements CommandsQueueRepository {
  ...
  /**
   * Creates a {@link DefaultCommandsQueueRepository} object with all fields initialized.
   *
   * @param session Snowpark session object
   * @param instanceSchema task reactor instance schema name
   */
  public DefaultCommandsQueueRepository(Session session, Identifier instanceSchema) {
